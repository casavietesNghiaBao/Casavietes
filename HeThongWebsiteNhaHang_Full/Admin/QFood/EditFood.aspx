            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="form-group">
                        <label for="example-text-input" class="col-form-label">ID Food</label>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtKhuyenmai" runat="server" placeholder="Discount..." class="form-control" />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Yêu cầu nhập khuyến mãi" ControlToValidate="txtName" Display="Dynamic" ForeColor="Red" />
                    </div>
                    ...
                    <asp:Button runat="server" ID="btnSua" class="btn btn-primary mt-4 pr-4 pl-4" Text="Edit" OnClick="btnSua_Click" />
                    <asp:Button runat="server" ID="btnLammoi" class="btn btn-primary mt-4 pr-4 pl-4" Text="Refresh" OnClick="btnLammoi_Click" />
